...
** Run the analysis on 3LZT (for Figure 2), delete the intermediate file
#+begin_src sh :results output :exports both
cd reproduction
...
rm crystal_fluctuations_3LZT_1_1_1.nc

#+end_src

** Run the analysis on 1IEE (for Figures 3 and 4), delete the intermediate files
#+begin_src sh :results output :exports both
cd reproduction
...
guix environment --container --ad-hoc python2 python2-mmtk -- python calculate_crystal_fluctuations.py 1IEE 1 2 1 2.99
...
guix environment --container --ad-hoc python2 python2-mmtk -- python calculate_crystal_fluctuations.py 1IEE 1 2 2 2.99
...
guix environment --container --ad-hoc python2 python2-mmtk -- python calculate_crystal_fluctuations.py 1IEE 2 2 1 2.99
...
rm crystal_fluctuations_1IEE_4_4_4.nc
...
** Reconstruct (partially) the plots
...
*** Figure 4
The elastic medium approximation is not computed by the scripts, so only the crystal modes will be plotted here.

#+begin_src gnuplot :tangle reproduction/fig4.gnuplot
set terminal png
set output "fig4.png"
plot "dispersion_1IEE_4_4_4.plot" w p
#+end_src
#+begin_src sh :results output :exports both
cd reproduction
